...
%path_folder_GitHub_ProjectEuler%Fortran\Problem0007\Problem0007.f08 ^
%path_folder_GitHub_ProjectEuler%Fortran\Problem0007\main.f08
...
%path_folder_gfortran%Problem0007.o ^
