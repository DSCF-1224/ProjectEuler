...
@SET path_folder_gfortran=D:\gfortran\
@SET path_folder_GitHub=D:\GitHub\
...
%path_folder_GitHub_ProjectEuler%Fortran\Problem0008\Problem0008.f08 ^
%path_folder_GitHub_ProjectEuler%Fortran\Problem0008\main.f08
...
%path_folder_gfortran%Problem0008.o ^
