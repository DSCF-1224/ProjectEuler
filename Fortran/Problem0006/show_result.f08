...
subroutine show_result_each_INT32 (version, target)
  ...
  select case (version)
    ...
    case (1)
      ...
      result = Problem0006_01 (target)
      call SYSTEM_CLOCK_UsingType (System_Clock_End)

    case (2)
      
      call SYSTEM_CLOCK_UsingType (System_Clock_Start)
      result = Problem0006_02 (target)
      call SYSTEM_CLOCK_UsingType (System_Clock_End)
...
subroutine show_result_INT32 (target)
  ...
  write(unit=name_file_save(8:10), fmt='(I3.3)') target
  name_file_save(01:07) = 'result_'
  name_file_save(11:20) = '_INT32.txt'
...
subroutine show_result_INT64 (target)
  ...
  write(unit=name_file_save(8:10), fmt='(I3.3)') target
  name_file_save(01:07) = 'result_'
  name_file_save(11:20) = '_INT64.txt'
